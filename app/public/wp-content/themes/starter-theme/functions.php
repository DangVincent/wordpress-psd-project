...
wp_deregister_script('jquery');
  ...
  wp_enqueue_script(
	'fontawesome', 
	'https://kit.fontawesome.com/117318af08.js',
	false,
	null,
	true
  );
...
function register_our_blocks() {
  ...
  acf_register_block_type(array(
	...
	'enqueue_style' => get_template_directory_uri() . '/admin/blocks.css',
  ));
...
// === Title And Link Block ===
  acf_register_block_type(array(
	'name'            => 'title-link',
	'title'           => __('Title and Link'),
	'category'        => 'common',
	'mode'            => 'auto',
	'icon'            => 'nametag',
	'render_template' => '/blocks/title-link.php',
	'enqueue_style' => get_template_directory_uri() . '/admin/blocks.css',
	));
}
